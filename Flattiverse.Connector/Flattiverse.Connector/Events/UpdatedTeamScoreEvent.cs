...
/// </summary>
public class UpdatedTeamScoreEvent : FlattiverseEvent
{
    /// <summary>
    ...
    internal UpdatedTeamScoreEvent(Team team, uint oldPlayerKills, uint oldPlayerDeaths, uint oldFriendlyKills, uint oldFriendlyDeaths,
