...
/// </summary>
public class SwitchedGateEvent : FlattiverseEvent
{
    /// <summary>
    ...
    internal SwitchedGateEvent(Cluster cluster, string switchName, Player? invokerPlayer, ControllableInfo? invokerControllableInfo,
