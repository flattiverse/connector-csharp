...
/// </summary>
public class RegisteredControllableInfoEvent : ControllableInfoEvent
{
    internal RegisteredControllableInfoEvent(Player player, ControllableInfo controllableInfo) :
