...
/// </summary>
public class UpdatedPlayerScoreEvent : PlayerEvent
{
    /// <summary>
    ...
    internal UpdatedPlayerScoreEvent(Player player, uint oldPlayerKills, uint oldPlayerDeaths, uint oldFriendlyKills,
        uint oldFriendlyDeaths, uint oldNpcKills, uint oldNpcDeaths, uint oldNeutralDeaths, int oldMission, uint newPlayerKills,
        uint newPlayerDeaths, uint newFriendlyKills, uint newFriendlyDeaths, uint newNpcKills, uint newNpcDeaths,
        uint newNeutralDeaths, int newMission) : base(player)
    {
