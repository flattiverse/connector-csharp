...
/// </summary>
public class UpdatedControllableInfoScoreEvent : ControllableInfoEvent
{
    /// <summary>
    ...
    internal UpdatedControllableInfoScoreEvent(Player player, ControllableInfo controllableInfo, uint oldPlayerKills,
