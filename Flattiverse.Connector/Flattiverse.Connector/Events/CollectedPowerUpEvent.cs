...
/// </summary>
public class CollectedPowerUpEvent : FlattiverseEvent
{
    /// <summary>
    ...
    internal CollectedPowerUpEvent(Controllable controllable, UnitKind powerUpKind, string powerUpName, float amount, float appliedAmount)
    {
