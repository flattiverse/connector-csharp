...
/// </summary>
public class ContinuedControllableInfoEvent : ControllableInfoEvent
{
    internal ContinuedControllableInfoEvent(Player player, ControllableInfo controllableInfo) :
